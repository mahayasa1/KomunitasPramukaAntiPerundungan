<form method="POST" action="{{ route('aspirasi.store') }}" enctype="multipart/form-data" class="space-y-4">
    @csrf
    ...
    <div>
        <label for="judul" class="block font-semibold text-gray-700">Judul Aspirasi *</label>
        <input type="text" id="judul" name="judul" class="w-full border rounded px-3 py-2" required>
    </div>

    <div>
        <label for="isi" class="block font-semibold text-gray-700">Isi Aspirasi *</label>
        <textarea id="isi" name="isi" rows="4" class="w-full border rounded px-3 py-2" required></textarea>
    </div>

    <div>
        <label for="asal" class="block font-semibold text-gray-700">Asal Pengusul</label>
    ...
    <div>
        <label for="lampiran" class="block font-semibold text-gray-700">Lampiran (Opsional, Max 20MB)</label>
        <input type="file" id="lampiran" accept="pdf" name="lampiran" class="w-full border rounded px-3 py-2">
    </div>
